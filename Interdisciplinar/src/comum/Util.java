...
public class Util {
    ...
    public static boolean mensagemDeConfirmacao(String texto, javax.swing.JFrame frame) {
        boolean desejaRealizar = JOptionPane.showConfirmDialog(frame, texto, "Atenção", JOptionPane.YES_NO_OPTION) == 0;
        return desejaRealizar;
    }
